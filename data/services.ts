...
export const servicePages: ServicePage[] = [
  {
    ...
    metaTitle: "İstanbul Moto Kurye | 7/24 Hızlı Motorlu Kurye | AcilJet",
    ...
    heroText: "Motorlu kurye, küçük ve orta boy gönderilerde trafik baskısını azaltan en pratik teslimat modelidir. AcilJet, talebi alır, paket tipini değerlendirir ve uygun ekibi hızlıca yönlendirir.",
    visual: "/aciljet-moto-service.webp",
  ...
  },
  {
    ...
    metaTitle: "VIP Kurye İstanbul | Acil ve Beklemesiz Teslimat | AcilJet",
  ...
  },
  {
    ...
    metaTitle: "Express Kurye İstanbul | 90 Dakika Hedefli Teslimat | AcilJet",
  ...
  },
  {
    ...
    metaTitle: "Araçlı Kurye İstanbul | Doblo, Panelvan ve Kamyonet | AcilJet",
    ...
    heroText: "Araçlı kurye, paket hacmi büyüdüğünde veya gönderi hassas taşıma istediğinde devreye girer. AcilJet, gönderiye göre binek, Doblo, panelvan veya kamyonet seçeneği değerlendirir.",
    visual: "/aciljet-parcel-van-premium.webp",
  ...
  },
  {
    ...
    metaTitle: "Gece Kurye İstanbul | 7/24 Acil Kurye Hizmeti | AcilJet",
  ...
  },
  {
    ...
    metaTitle: "Şehirlerarası Kurye | Uçak Kargo ve Otobüs Kargo | AcilJet",
